...
<head>
    <meta charset="utf-8" />
    <title>Vertical Layout | Ubold - Responsive Bootstrap 5 Admin Dashboard</title>
...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item">
                            ...
                            <div class="collapse" id="menuLayouts">
                                <ul class="sub-menu">
                                    <li class="menu-item">
                                        <a href="layouts-vertical.html" target="_blank" class="menu-link">
        ...
        <ul class="topbar-menu d-flex align-items-center">
            ...
            <li class="dropdown d-none d-md-inline-block">
                <a class="nav-link dropdown-toggle waves-effect waves-light arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('backend/assets/images/flags/us.jpg') }}" alt="user-image" class="me-0 me-sm-1" height="18">
                </a>
